...
/* A função push é uma função somente de Array, não de objetos, mas como a 
propriedade olhos é um array, posso usar a função push nela */
...
let personagemBens = {
  nome: "Erivelton",
  idade: 32,
  /* Cada carro será um objeto, preste atenção na vírgula, a vírgula dentro do 
objeto é a vírgula do objeto, a vírgula de fora do objeto é a vírgula do array.
...
/* Lembrando que carros é um array, por ser array eu não posso usar ponto e
preciso acessar a posição do primeiro objeto [0], em seguida como é um objeto, 
eu acesso com ponto e em seguida a propriedade que eu quero (cor) */
console.log(personagem.carros[0].cor);
// Resultado: preto

// Se quisesse acessar o segundo carro e pegar seu modelo, como o segundo carro é o segundo item do meu array, eu coloco o [1] e em seguida o seu modelo que é   um objeto.
