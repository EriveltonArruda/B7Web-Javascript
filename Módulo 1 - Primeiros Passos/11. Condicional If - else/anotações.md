Condicionais são ações que queremos que o código faça a partir de tal condição, um bom exemplo é o acelerador de um carro, um carro só anda SE o acelerador for acionado.
